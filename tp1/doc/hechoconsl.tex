...
\linebreak Subversion es un sistema de control de versiones diseñado
  ...
  tanto el código fuente de Minix como el de éste documento.

% QEMU
\item \textbf{QEMU} - \href{http://fabrice.bellard.free.fr/qemu/}
  {http://fabrice.bellard.free.fr/qemu/}
\linebreak QEMU es una emulador libre, que se caracteriza por ser
 rápido.
